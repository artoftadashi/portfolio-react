...
export default function ProjectModal({ project, onClose }) {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-[rgba(0,0,0,0.5)] backdrop-blur-sm flex flex-col justify-center items-center  gap-4 z-10 ">
      ...
      <motion.div
        className="bg-[#050505] p-8 md:p-16 w-4/5 lg:w-2/3 rounded-2xl z-10 modal-content "
