  ...
  return (
    <section className="p-32 bg-[#87FF65] rounded-t-[50px] mx-auto">
      <h3 className="uppercase font-bold text-[7rem] font-[Thunder] leading-[8rem] ">
        ...
        leading <span className="underline ">brands and startups.</span>
      </h3>
      ...
      <a href="#" className="flex items-center gap-4 mt-20 group ">
        <p className="text-3xl font-innerTight">Learn more</p>
        <img
