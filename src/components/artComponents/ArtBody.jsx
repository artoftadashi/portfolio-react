export default function ArtBody({ content, onSelectPrev, onSelectNext }) {
  ...
  let centerImageClass = `lg:w-[26rem] lg:h-[32rem] w-[14rem] h-[18rem] sm:w-[20rem] h-[24rem] rounded-3xl absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] md:rotate-[5deg] rotate-0 -z-[2] bg-no-repeat overflow-hidden bg-cover bg-center animate-fade animate-delay-[.15s]  `;
  return (
    <>
      <div
      ...
      >
        <div className="lg:py-8 lg:px-16 px-8 py-4 h-[100vh] w-[100vw] backdrop-blur-md bg-[#020202]/40 relative">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between py-28 md:py-0 md:justify-evenly m-auto w-full h-full ">
            <h1 className=" text-center md:text-left uppercase xl:text-[8rem] lg:text-[6rem] sm:text-[3rem] text-[3rem] font-[Thunder] xl:leading-[7rem] lg:leading-[5rem] sm:leading-[4rem] leading-[3rem] text-white tracking-wide md:w-[30%] w-fit drop-shadow-xl animate-fade-right ">
              {content.caption}
            </h1>
