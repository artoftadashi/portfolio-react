export default function ArtBody() {
  return (
    <>
      <div className=" w-full h-[100vh] bg-[url('../src/assets/artImages/no1.png')] bg-no-repeat overflow-hidden bg-cover bg-center ">
        <div className="py-8 px-16 h-[100vh] w-[100vw] backdrop-blur-md relative">
          {/* my logo */}
          ...
          {/* center image */}
          <div className="w-[26rem] h-[32rem] rounded-3xl absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] rotate-[5deg] -z-[2]  ">
            <img
              src="../src/assets/artImages/no1.png"
