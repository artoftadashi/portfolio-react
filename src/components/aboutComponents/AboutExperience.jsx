...
export default function AboutExperience() {
  return (
    <section className="lg:p-32 p-12 sm:p-16 mx-auto bg-[#87FF65]">
      <h3 className="uppercase  text-[2.5rem] md:text-[3.5rem] lg:text-[4.5rem] xl:text-[7rem] font-[Thunder] leading-[3rem] lg:leading-[6rem] xl:leading-[8rem] border-b-4 border-[#050505] w-fit  ">
      ...
      <a
        href="./cv/SamuelOlanrewaju_CV.pdf"
        target="_blank"
