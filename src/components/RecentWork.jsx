...
export default function RecentWork() {
  ...
  return (
    <section className="bg-[#050505] px-12 md:px-16 py-16 lg:py-32 h-auto">
      <h1 className="text-[3.5rem] sm:text-[4.5rem] md:text-[7rem] lg:text-[8rem] xl:text-[9.5rem] 2xl:text-[10rem] text-[#fafaff] lg:font-bold uppercase  text-center font-[Thunder]">
        Recent work
      </h1>
